...
import numpy as np
import wandb
wandb.init(project="dscl-kidney-ptr-decoder", config=tf.flags.FLAGS)
#to make directories
import pathlib
...
parser.add_argument('--no_of_tr_imgs', type=str, default='tr52', choices=['tr52','tr22','tr10','ptr'])
