...
data_path_tr='/scratch/st-rohling-1/contrastive_learning/domain_specific_cl/data/Task001_KidneyCapsule/'
...
data_path_tr_cropped='/scratch/st-rohling-1/contrastive_learning/domain_specific_cl/data/Task001_KidneyCapsule_Cropped/'
################################################################
